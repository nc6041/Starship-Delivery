...
public class TextUITester {
    ...
    public static void main(String[] args) {
      ...
      /*
       * Test 1: checks to see if incorrect inputs will output invalid text.
       */
        ...
        StarshipFrontEnd frontEnd = new StarshipFrontEnd();
        StarshipBackend backend = new StarshipBackend();
        frontEnd.runner(backend); // (this code should read from System.in and write to System.out)
        ...
        if(output.startsWith("Please input the number that corresponds to what you would like to do.\n"
            ...
            + "     7. Print time\n" 
            + "     8. Quit") && 
           output.contains("Invalid input. Enter a number from 1-8 corresponding to the command you would like to execute."))
        ...
        /*
         * Test 2-1: tests to see if the correct output for inserting a new location that is new
         */
        ...
        if(output2.startsWith("Please input the number that corresponds to what you would like to do.\n"
            ...
            + "     7. Print time\n" 
            + "     8. Quit") && 
           output2.contains("What is the name of the location you would like to add") &&
           output2.contains("Location added"))
          System.out.println("Test 2-1 passed");
        else
            System.out.println("Test 2-1 FAILED.");
        
        /*
         * Test 2-2: tests to see if the correct output for inserting a new location that is already in the graph
         */
        tester2 = new TextUITester("1\nMemorial Union");
        ...
        if(output2.startsWith("Please input the number that corresponds to what you would like to do.\n"
            ...
            + "     8. Quit") && 
           output2.contains("What is the name of the location you would like to add") &&
           output2.contains("Location is already in the graph"))
        ...
        /*
         * Test 3: tests to see if finding the distance between two locations outputs correctly
         */
        TextUITester tester3 = new TextUITester("5\nMemorial Union\nCollege Library");
        ...
        if(output3.startsWith("Please input the number that corresponds to what you would like to do.\n"
            ...
            + "     7. Print time\n" 
            + "     8. Quit") && 
           output3.contains("What is your start location?") &&
           output3.contains("What is your end location?") &&
           output3.contains("Memorial Union from College Library is 22 units far from each other"))
